...
export const ChangeQuantityOfBook: React.FC<{
  ...
  async function increaseQuantity() {
    const url = `${config.baseURL}/api/admin/secure/increase/book/quantity/?bookId=${props.book?.id}`;
  ...
  async function decreaseQuantity() {
    const url = `${config.baseURL}/api/admin/secure/decrease/book/quantity/?bookId=${props.book?.id}`;
    const requestOptions = {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
  ...
  async function deleteBook() {
    const url = `${config.baseURL}/api/admin/secure/delete/book/?bookId=${props.book?.id}`;
    const requestOptions = {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
